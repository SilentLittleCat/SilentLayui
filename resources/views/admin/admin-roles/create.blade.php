        ...
        <div class="layui-col-sm8 layui-col-sm-offset2">
            <form class="layui-form" method="POST" action="{{ $pre_uri . 'store' }}">
                ...
                <div class="layui-form-item {{ $errors->has('desp') ? 'has-error' : '' }}">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="data[desp]" value="{{ isset(old('data')['desp']) ? old('data')['desp'] : '' }}" required lay-verify="required" placeholder="请输入描述" autocomplete="off" class="layui-input">
                        @if($errors->has('desp'))
                ...
                <div class="layui-form-item">
                    <div class="layout-inline">
                        ...
                        <div class="layui-input-inline">
                            @include('shared.multi-select', ['id' => 'sg-menu-permissions', 'name' => 'menuPermissions[]',  'options' => $model->getMenuPermissionOptions(), 'selected_options' => []])
                        </div>
                    </div>
                    <div class="layout-inline">
                        <label class="layui-form-label">操作权限</label>
                        <div class="layui-input-inline">
                            @include('shared.multi-select', ['id' => 'sg-action-permissions', 'name' => 'actionPermissions[]',  'options' => $model->getActionPermissionOptions(), 'selected_options' => []])
                        </div>
                    </div>
                </div>
